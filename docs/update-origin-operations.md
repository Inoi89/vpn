...
```powershell
powershell -ExecutionPolicy Bypass -File .\deploy\client\publish-update-origin.ps1 -Version 0.1.2 -ServerPassword <root-password> -ServerHost 37.1.197.163 -Domain vpn.udni.ru -PackageBaseUrl https://vpn.udni.ru/vpn-client/stable -ReleaseNotes "0.1.2 minimal single-screen desktop UI." -UploadZip
```
